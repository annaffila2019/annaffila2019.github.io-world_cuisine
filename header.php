...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a class="navbar-brand" href="#">World Cuisine</a>
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="indonesian.php">Indonesian Cuisines</a></li>
                    <li><a class="dropdown-item" href="european.php">European Cuisines</a></li>
                </ul>
                </li>
                <li class="nav-item">
